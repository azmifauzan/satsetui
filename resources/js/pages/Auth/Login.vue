    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center">
              <input
                ...
                type="checkbox"
                class="w-4 h-4 text-blue-600 bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-600 rounded focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2"
              />
              <span class="ml-2 text-sm text-slate-600 dark:text-slate-400">{{ t().remember }}</span>
            </label>
        ...
        <div class="mt-6 text-center">
          <span class="text-slate-600 dark:text-slate-400">{{ t().noAccount }}</span>
          <Link href="/register" class="ml-1 text-blue-600 dark:text-blue-400 hover:underline font-medium">
            {{ t().register }}
          </Link>
        </div>
      </div>
