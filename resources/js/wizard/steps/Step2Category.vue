...
import { wizardState, Category } from '../wizardState';
  ...
  <div class="space-y-6">
    <div>
      ...
      <p class="text-slate-600 dark:text-slate-400">
        Choose the primary use case for your template. This will influence default page recommendations and layout patterns.
      </p>
    </div>
